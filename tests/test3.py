...
def run(path, ending):
    ...
    for directory in list_of_graphs:
        ...
        for i in r:
            index += 1
            command = '" C:\\Users\\user\\AppData\\Local\\Programs\\Python\\Python39\\python.exe" ' + "C:\\Users\\user\\Desktop\\wppt\\metaheurystyczne\\src\\main.py load " + f"C:\\Users\\user\\Desktop\\wppt\\metaheurystyczne\\vendors\\ALL_tsp\\{os.listdir(cwd)[0]}\\{os.listdir(cwd)[0]}" + f" tabu 200,{i},50,20"
